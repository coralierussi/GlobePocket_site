<template>
    <main id="transportsPage">
        <HeaderSite/>
        
        <div class="img-presentation">
            <img class="img-activites" src="../assets/PhotosSite/principale-activite.jpeg" alt="Image page activités" >
            <div class="text-presentation">
                <h1>Découvrez les meilleurs transports à faire utiliser pendant votre voyage !</h1>
            </div>
        </div>

        <div class="titre">
            <p class="text-titre">Choisis ton moyen de transport pour voyager</p>
        </div>
