<template>
    <main id="hebergementPage">
        <HeaderSite/>
        
        <div class="img-presentation">
            <img class="img-activites" src="../assets/PhotosSite/principale-activite.jpeg" alt="Image page activités" >
            <div class="text-presentation">
                <h1>Découvrez les meilleurs hébergements à essayer pendant votre voyage !</h1>
                <p>Nature, athypique ou classique : choisis ce qui te fais envie</p>
            </div>
        </div>

        <div class="titre">
            <p class="text-titre">Explore parmis plus de 200 logements testées et approuvées par nos voyageurs</p>
        </div>
