<template>
    <main id="locationPage">
        <HeaderSite/>
        
        <div class="img-presentation">
            <img class="img-activites" src="../assets/PhotosSite/principale-activite.jpeg" alt="Image page activités" >
            <div class="text-presentation">
                <h1>Découvrez tous les véhicules que vous pouvez utiliser pendant votre voyage !</h1>
            </div>
        </div>

        <div class="titre">
            <p class="text-titre">Trouvez le véhicule adapté à votre besoin </p>
        </div>
